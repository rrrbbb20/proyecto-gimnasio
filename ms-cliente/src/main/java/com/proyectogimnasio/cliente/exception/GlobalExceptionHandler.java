package com.proyectogimnasio.cliente.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<com.proyectogimnasio.cliente.dto.ApiResponse<Object>> handleAccessDenied(
            org.springframework.security.authorization.AuthorizationDeniedException ex) {
        return ResponseEntity.status(403).body(
                com.proyectogimnasio.cliente.dto.ApiResponse.builder()
                        .success(false)
